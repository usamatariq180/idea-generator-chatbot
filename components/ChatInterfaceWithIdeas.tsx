  ...
  return (
    <div className="flex flex-col h-screen bg-[#111111] text-[#e3e3e3] sm:mx-[8%] mx-[4%] font-mono">
      ...
      <div className="flex flex-col md:flex-row flex-1 overflow-hidden gap-4 mt-4 mb-4">
          ...
          {isOpen && (
            <div className="p-4 space-y-2 overflow-y-auto sm:min-h-full min-h-[calc(100vh-23vh)] ">
              {savedIdeas.map((idea, index) => (
                <div
                  key={index}
                  className="p-2 bg-[#372b1d] rounded-lg text-[12px]"
                >
                  {idea}
                </div>
              ))}
        ...
        {!isOpen && (
          <div className="flex flex-col w-full md:w-2/3 bg-[#1a1a1a] rounded-xl p-6 sm:min-h-full min-h-[calc(100vh-26vh)]">
            <div
              ref={chatWindowRef}
        ...
        <div className="sm:flex flex-col w-full md:w-1/3 bg-[#1a1a1a] rounded-xl p-6 hidden">
          ...
          <div className="flex-1 overflow-y-auto space-y-2 pr-2">
            {savedIdeas.map((idea, index) => (
              <div
                key={index}
                className="p-2 bg-[#372b1d] rounded-lg sm:text-sm text-[12px]"
              >
                {idea}
              </div>
            ))}
